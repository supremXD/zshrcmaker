...
def install():
	...
	os.system("echo alias cptoserver='python3 /home/suprem/Documents/commandsshortcuts/cptoserver.py' >> .zshrc")
	os.system("echo alias mvtoserver='python3 /home/suprem/Documents/commandsshortcuts/mvtoserver.py' >> .zshrc")
	...
	os.system("echo alias wichsystem='python3 /home/suprem/Documents/commandsshortcuts/whichsystem.py' >> .zshrc")
	os.system("echo alias debinstall='sudo dpkg -i' >> .zshrc")
	os.system("alias autoserver='bash /home/suprem/Documents/commandsshortcuts/autoserveranddownloading/autoserver/autoserver.sh'")
	os.system("alias autodownload='bash /home/suprem/Documents/commandsshortcuts/autoserveranddownloading/autodownload/autodownload.sh'")
	os.system("clear")
	print("")
