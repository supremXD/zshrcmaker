...
def install():
	...
	os.system("alias autoserver='bash /home/suprem/Documents/commandshortcuts/autoserveranddownloading/autoserver/autoserver.sh'")
	os.system("alias autodownload='bash /home/suprem/Documents/commandshortcuts/autoserveranddownloading/autodownload/autodownload.sh'")
	os.system("clear")
	print("")
